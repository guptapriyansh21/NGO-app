...
public class DataAdapterGalleryImages extends RecyclerView.Adapter<DataAdapterGalleryImages.ViewHolder> {
    private ArrayList<ImageUrl> imageUrls;
    private Context context;

    public DataAdapterGalleryImages(Context context, ArrayList<ImageUrl> imageUrls) {
    ...
    @Override
    public DataAdapterGalleryImages.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int i) {
        viewHolder.txtDesc.setText(imageUrls.get(i).getDescription());
...
//                Intent intent=new Intent(context,ImageZoomer.class);
